...
Taken from https://github.com/storborg/packagetrack
Modified to work with Python 3
TODO: Replace this code with https://github.com/martinblech/xmltodict
...
class NotTextNodeError(BaseException): pass
